...
public class ClaimCommand implements Command {
    ...
    public String getDescription() {
        return Locale.getRawMessage("commands.claim.description");
    }

    @Override
    public String getUsage() {
        return Locale.getRawMessage("commands.claim.usage");
    }

    @Override
    public void execute(CommandSender sender, String[] args) {

        if (!isPlayer(sender) || !hasPermission(sender, "claim")) {
            return;
        }

        String mode = "claim-single";
