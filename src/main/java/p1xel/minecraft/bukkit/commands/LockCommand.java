...
public class LockCommand implements Command {
    ...
    public String getDescription() {
        return Locale.getRawMessage("commands.lock.description");
    }

    @Override
    public String getUsage() {
        return Locale.getRawMessage("commands.lock.usage");
    }

    @Override
    public void execute(CommandSender sender, String[] args) {

        if (!isPlayer(sender) || !hasPermission(sender, "lock")) {
            return;
        }

        String mode = "lock-single";
