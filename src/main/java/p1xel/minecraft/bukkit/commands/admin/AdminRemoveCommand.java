...
public class AdminRemoveCommand implements Command {
    ...
    public String getDescription() {
        return Locale.getRawMessage("commands.admin.children.remove.description");
    }

    @Override
    public String getUsage() {
        return Locale.getRawMessage("commands.admin.children.remove.usage");
    }

    @Override
    public void execute(CommandSender sender, String[] args) {

        if (!isPlayer(sender) || !hasPermission(sender, "admin.remove")) {
            return;
        }

        String mode = "admin-remove-single";
